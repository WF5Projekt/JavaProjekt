...
public abstract class Database_Model {
    ...
    protected static Connection getConnection() {
        ...
        // catch Error: MySQL Driver not found    
            ...
            JOptionPane.showMessageDialog(null, "MySQL Driver not found.", "Information", JOptionPane.INFORMATION_MESSAGE);
            System.exit(0);
        // catch Error: Connection to Database failed    
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Connection to Database failed \ndbHost: " + dbHost + "\ndbPort: " + dbPort + "\ndatabase: " + database, "Information", JOptionPane.INFORMATION_MESSAGE);
            System.exit(0);
        // catch other Errors    
        } catch (Exception ex) {
